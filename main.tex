...
\usepackage{wrapfig}
\usepackage{etoolbox}
\usepackage[a5paper, bindingoffset=5mm, left=1.3cm, top=1.75cm, right=1.3cm, bottom=2cm, footskip=17.5pt]{geometry}
\usepackage{hyperref}
\hypersetup{
    colorlinks,
    citecolor=black,
...
\begin{document}
    ...
    \vfill
    \textbf{PDF Booklet Editor} – @Kyek; Layout: @keraldi
